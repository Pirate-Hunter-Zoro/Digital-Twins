...
def parse_data_args():
    ...
    parser.add_argument("--vectorizer_method", type=str, default="biobert-mnli-mednli", choices=["biobert-mnli-mednli", "BioBERT-mnli-snli-scinli-scitail-mednli-stsb"], help="Method for vectorization.")
