...
* **`classical_ml.py`**:
  ...
  * **Classifiers** (4 total):
    ...
    * Random Forest
    * Histogram-based Gradient Boosting (`HistGradientBoostingClassifier`) — NaN-native; required for the planned `VitalsStrategy` sensitivity arms that feed NaN-bearing matrices to the tree branch
